...
export const MESSAGES = {
  ...
  */
  ...
  /*
    ...
    and `rateLimited` above talks about an allowance that does not exist for
    signing in — it was borrowed from the AI tutor's message for a failure
    that has nothing to do with it. This one names the wait and the door that
    does not depend on remembering a password at all.
  */
