...
export const THEME_INIT_SCRIPT = `try{var t=localStorage.getItem(${JSON.stringify(
  THEME_KEY,
)});t=(t==="light"||t==="dark"||t==="warm")?t:"warm";document.documentElement.dataset.theme=t;var m=document.querySelector('meta[name="theme-color"]');if(!m){m=document.createElement("meta");m.name="theme-color";document.head.appendChild(m)}m.content=({warm:"#e7e0d8",light:"#ffffff",dark:"#111113"})[t]}catch(e){}`;
