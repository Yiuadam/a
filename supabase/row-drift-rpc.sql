          ...
          select s.user_id::text || '/' || s.store_key::text as row_key,
                 public.cloudflare_migration_fingerprint_field(s.user_id::text) || '|'
                   ...
                   || public.cloudflare_migration_fingerprint_field(
                        to_char(s.updated_at at time zone 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.US"Z"')) as identity
        ...
        from (
          select e.id::text as row_key,
                 public.cloudflare_migration_fingerprint_field(e.id::text) || '|'
                   ...
                   || public.cloudflare_migration_fingerprint_field(
                        to_char(e.created_at at time zone 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.US"Z"')) as identity
        ...
        from (
          select e.id::text as row_key,
                 public.cloudflare_migration_fingerprint_field(e.id::text) || '|'
                   ...
                   || public.cloudflare_migration_fingerprint_field(
                        to_char(e.recorded_at at time zone 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS.US"Z"')) as identity
