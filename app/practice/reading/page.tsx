...
function ReadingTestPageRunner() {
  ...
  */
  ...
  /*
    ...
    the paper, the score footer) the same way listening's own paperScrollRef
    does. SplitPanes and SwipePanels additionally reset their own panes via
  ...
  */
  ...
  return (
    <div
      ref={pageRef}
      className={`h-full min-h-0 space-y-4 overflow-y-auto ${submitted ? "practice-result-page" : ""}`}
    >
      {submitted && band !== null && (
